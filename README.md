...
- [ ] Email / webhook alerts on trade execution
- [ ] Support for additional assets (ETH, SOL, etc.)
- [ ] Subscription API key support (bypass per-fetch x402 for monthly plans)
- [ ] MCP server integration — let AI agents discover and subscribe to strategies autonomously
